...
export default function MaintenanceForm({ onAddMaintenance, onMaintenanceCreated, initialVehicle, initialDescription, initialType, initialMaintenanceId }) {
    ...
    return (_jsxs("div", { className: "bg-white/30 backdrop-blur-lg rounded-2xl p-6 border border-white/30 shadow-xl", children: [_jsx("div", { className: "text-xl font-bold mb-2", children: t('dashboard.fleet.scheduleMaintenance', 'Schedule Maintenance') }), _jsxs("form", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", onSubmit: handleSubmit, children: [_jsxs("div", { children: [_jsxs("label", { className: "block text-sm font-medium mb-1", children: [t('dashboard.fleet.selectVehicle'), " ", _jsx("span", { className: 'text-red-500', children: "*" })] }), _jsx("select", { name: "vehicle", value: form.vehicle, onChange: handleChange, className: "w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-violet-400", required: true, disabled: loadingVehicles || isEmergency, children: vehicleOptions.map(opt => (_jsx("option", { value: opt.value, children: opt.label }, opt.value))) }), loadingVehicles && _jsx("div", { className: "text-xs text-gray-500 mt-1", children: t('dashboard.fleet.loadingVehicles', 'Loading vehicle list...') }), vehicleError && _jsx("div", { className: "text-xs text-red-500 mt-1", children: vehicleError })] }), _jsxs("div", { children: [_jsxs("label", { className: "block text-sm font-medium mb-1", children: [t('dashboard.fleet.maintenanceType', 'Maintenance Type'), " ", _jsx("span", { className: 'text-red-500', children: "*" })] }), _jsx("select", { name: "type", value: form.type, onChange: handleChange, className: "w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-violet-400", required: true, disabled: isEmergency, children: getTypeOptions().map(opt => (_jsx("option", { value: opt.value, children: opt.label }, opt.value))) })] }), _jsxs("div", { className: "md:col-span-2", children: [_jsx("label", { className: "block text-sm font-medium mb-1", children: t('dashboard.fleet.workDescription', 'Work Description') }), _jsx("input", { name: "description", value: form.description, onChange: handleChange, className: "w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-violet-400", placeholder: t('dashboard.fleet.workDescriptionPlaceholder', 'Describe the work to be performed in detail'), disabled: isEmergency })] }), _jsxs("div", { className: "md:col-span-2", children: [_jsx("label", { className: "block text-sm font-medium mb-1", children: t('dashboard.fleet.notes') }), _jsx("textarea", { name: "notes", value: form.notes, onChange: handleChange, className: "w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-violet-400", placeholder: t('dashboard.fleet.notesPlaceholder', 'Enter notes (if any)'), rows: 2 })] }), _jsxs("div", { children: [_jsxs("label", { className: "block text-sm font-medium mb-1", children: [t('dashboard.fleet.implementationDate', 'Implementation Date'), " ", _jsx("span", { className: 'text-red-500', children: "*" })] }), _jsx("input", { name: "date", type: "date", value: form.date, onChange: handleChange, className: "w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-violet-400", required: true })] }), _jsxs("div", { children: [_jsxs("label", { className: "block text-sm font-medium mb-1", children: [t('dashboard.fleet.estimatedCost', 'Estimated Cost'), " (VN\u0110)"] }), _jsx("input", { name: "cost", type: "number", min: "0", value: form.cost, onChange: handleChange, className: "w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-violet-400" })] }), _jsxs("div", { className: "md:col-span-2", children: [_jsx("label", { className: "block text-sm font-medium mb-1", children: t('dashboard.fleet.nextMaintenance', 'Next Maintenance') }), _jsx("input", { name: "nextMaintenance", type: "date", value: form.nextMaintenance, onChange: handleChange, className: "w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-violet-400", placeholder: "Ng\u00E0y b\u1EA3o tr\u00EC ti\u1EBFp theo" })] }), _jsx("div", { className: "md:col-span-2 mt-4", children: _jsxs("button", { type: "submit", className: "w-full flex items-center justify-center gap-2 bg-violet-600 hover:bg-violet-700 text-white font-semibold py-3 rounded-lg text-base transition", children: [_jsx(Calendar, { size: 20 }), " ", t('dashboard.fleet.scheduleMaintenance')] }) })] })] }));
}
