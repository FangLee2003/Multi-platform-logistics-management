...
const VehicleTable = ({ vehicles, onEdit, onDelete, }) => {
    ...
    return (_jsx("div", { className: "space-y-4", children: vehicles.map((vehicle) => {
            ...
            return (_jsx("div", { className: "bg-white border border-gray-200 rounded-xl p-6 hover:shadow-md transition-all duration-200", children: _jsxs("div", { className: "flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4", children: [_jsxs("div", { className: "flex-1 space-y-3", children: [_jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [_jsx("h3", { className: "text-xl font-bold text-gray-900", children: vehicle.licensePlate }), _jsx(StatusBadge, { status: computedStatus, t: t })] }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm", children: [_jsxs("div", { className: "space-y-1", children: [_jsxs("span", { className: "text-gray-500 font-medium", children: [t('dashboard.fleet.vehicleType', 'Vehicle Type'), ":"] }), _jsx("div", { className: "text-gray-900", children: vehicle.type })] }), _jsxs("div", { className: "space-y-1", children: [_jsxs("span", { className: "text-gray-500 font-medium", children: [t('dashboard.fleet.capacity', 'Capacity'), " (kg):"] }), _jsxs("div", { className: "text-gray-900 font-semibold", children: [vehicle.capacityWeightKg?.toLocaleString() ?? "-", " kg"] })] }), _jsxs("div", { className: "space-y-1", children: [_jsxs("span", { className: "text-gray-500 font-medium", children: [t('dashboard.fleet.volume', 'Volume'), " (m\u00B3):"] }), _jsxs("div", { className: "text-gray-900 font-semibold", children: [vehicle.capacityVolumeM3?.toLocaleString() ?? "-", " m\u00B3"] })] }), _jsxs("div", { className: "space-y-1", children: [_jsxs("span", { className: "text-gray-500 font-medium", children: [t('dashboard.fleet.driver', 'Driver'), ":"] }), _jsx("div", { className: "text-gray-900", children: vehicle.driver?.name ||
                                                        vehicle.currentDriver?.fullName || (_jsx("span", { className: "text-gray-400 italic", children: t('dashboard.fleet.notAssigned', 'Not Assigned') })) })] })] }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4 text-sm pt-2 border-t border-gray-100", children: [_jsxs("div", { className: "space-y-1", children: [_jsx("span", { className: "text-gray-500 font-medium", children: "B\u1EA3o tr\u00EC g\u1EA7n nh\u1EA5t:" }), _jsx("div", { className: "text-gray-900", children: vehicle.lastMaintenance || (_jsx("span", { className: "text-gray-400 italic", children: "Ch\u01B0a c\u00F3 th\u00F4ng tin" })) })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("span", { className: "text-gray-500 font-medium", children: "B\u1EA3o tr\u00EC ti\u1EBFp theo:" }), _jsx("div", { className: maintenanceUrgencyColor, children: vehicle.nextMaintenance ? (_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { children: vehicle.nextMaintenance }), daysUntilMaintenance !== null && (_jsx("span", { className: "text-xs px-2 py-1 rounded-full bg-gray-100", children: daysUntilMaintenance < 0
