...
export default function LoginForm({ onLogin }) {
    ...
    return (_jsxs("div", { className: "min-h-screen w-full flex items-center justify-center bg-cover bg-center relative overflow-hidden", style: {
        ...
        }, children: [_jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-blue-900/30 via-purple-900/20 to-indigo-900/30 backdrop-blur-sm z-0" }), _jsx("div", { className: "absolute top-6 right-6 z-20 drop-shadow-lg", children: _jsx(LanguageSwitcher, {}) }), _jsxs("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [_jsx("div", { className: "absolute top-1/4 left-1/4 w-72 h-72 bg-blue-400/10 rounded-full blur-3xl animate-pulse" }), _jsx("div", { className: "absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-400/10 rounded-full blur-3xl animate-pulse delay-700" }), _jsx("div", { className: "absolute top-3/4 left-3/4 w-64 h-64 bg-indigo-400/10 rounded-full blur-3xl animate-pulse delay-1000" })] }), _jsxs("div", { className: "relative z-10 flex flex-col items-center w-full max-w-md px-6", children: [_jsxs("div", { className: "mb-8 text-center", children: [_jsx("h1", { className: "text-3xl font-bold text-white drop-shadow-lg", children: "Fast Route" }), _jsx("p", { className: "text-white/70 text-sm mt-2", children: t('common.welcome') })] }), _jsxs("form", { onSubmit: handleSubmit, className: "w-full bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl px-8 py-10 space-y-6 transform transition-all duration-500 ", children: [_jsxs("div", { className: "text-center mb-8", children: [_jsx("h2", { className: "text-2xl font-semibold text-white drop-shadow-lg", children: t('auth.login.title') }), _jsx("p", { className: "text-white/70 text-sm mt-2", children: t('auth.login.subtitle') })] }), _jsxs("div", { className: "space-y-2", children: [_jsx("label", { htmlFor: "email", className: "block text-white/90 text-sm font-medium drop-shadow", children: t('auth.login.email') }), _jsxs("div", { className: "relative group", children: [_jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-xl blur opacity-0 group-hover:opacity-100 transition-opacity duration-300" }), _jsx("input", { id: "email", type: "email", value: email, onChange: e => {
